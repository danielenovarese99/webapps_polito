...
function MovieForm(props) {
    ...
    const MovieManagement = useContext(Movies);
    ...
    const submitForm = (event) => {
        ...
        if (props.currentAnswer) {
            let newFilm = new Film(props.currentAnswer.id, formTitle, formDate, formFavorite, formRating);

            props.modifyMovie(props.filter, newFilm);
            //props.cancelAction(false);
        }
        else {
            let newFilm = new Film(MovieManagement.count, formTitle, formDate, formFavorite, formRating);

            MovieManagement.updatefunction(newFilm);
            navigate('../Movies/All');
            //props.updatemovielist(props.filter, newFilm);
            //props.cancelAction(false);
        }
    }
